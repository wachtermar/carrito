...
</head><body><h1>Alcampo login</h1><p class="note">This local page sends your credentials only to the alcampo CLI running on this computer. The password is used once to create a session and is not stored.</p>
