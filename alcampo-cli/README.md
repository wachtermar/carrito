...
Food planning stores local memory under `ALCAMPO_CONFIG_DIR/food/` or `~/.alcampo/food/`. Recipe data lives in SQLite at `food/recipes.db`; profile, pantry, meal plan, and history files remain transparent JSON/JSONL:
