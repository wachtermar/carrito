...
10. For low-intervention planning and shopping after intake, prefer `carrito food run --days <n> --people <n> --meals dinner --selection-policy <policy> --basket-out basket.txt --json`.
...
14. Create printable artifacts with `carrito food recipe <prompt|mealplan-id> --json --out <recipe.json>` and `carrito food pdf <recipe-or-plan-or-shop.json> --out <file.pdf>`.
