...
5. Present review output before cart mutation:
   ...
   - `artifact_audit.status`, `artifact_audit.hermes_trust_summary.trustworthy`, `may_present_basket_as_ready`, `may_present_cook_ready`, `may_present_nutrition_numbers`, and any required user warning
