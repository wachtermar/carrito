...
func foodRunArtifactPaths(planOut, shopOut, runPath, pdfPath, basketPath, ledgerOut, nutritionLedgerOut, budgetDealOut, servingPlanOut, scaledMealPlanOut, pantryOut, pantryConsumptionOut, readinessOut, recoveryOut, recipeSwapOut, basketOptimizationOut, recipeIntakeOut, recipeQualityOut string) map[string]string {
