...
func printHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  carrito food <profile|pantry|plan|use-up|recipe|recipes|shop|pdf|html|run|cook|receive|import-orders|import-receipt|history|staples>")
}
...
func printFoodHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  carrito food html <recipe-or-plan-shop-run.json> --out file.html [--cover-image path-or-url]")
	fmt.Fprintln(w, "  carrito food run --days N --people N [--selection-policy POLICY] [--servings N|--adult-servings N --child-servings N --toddler-servings N|--household-profile household.json] [--serving-plan-out serving.json] [--scaled-mealplan-out scaled.json] [--strict-servings|--no-serving-scaling] [--basket-out basket.txt] [--run-out run.json] [--quantity-ledger-out ledger.json] [--nutrition-ledger-out nutrition.json] [--nutrition-mode off|labels|recipe|hybrid] [--require-nutrition-ready] [--min-nutrition-line-coverage R] [--min-nutrition-quantity-coverage R] [--include-purchased-excess-nutrition] [--allow-pantry-profile-nutrition=false] [--allow-builtin-pantry-nutrition] [--product-evidence-out product_evidence.json] [--refresh-product-evidence|--no-product-evidence-refresh] [--require-fresh-product-evidence] [--allow-product-evidence-cache|--no-product-evidence-cache] [--intent-file intent.json] [--intent-out intent.json] [--constraint-report-out constraints.json] [--require-intent-ready] [--max-cook-minutes N] [--exclude-ingredient NAME] [--exclude-allergen NAME] [--diet-rule RULE] [--recovery-out recovery.json] [--recipe-swap-out recipe_swap.json] [--basket-optimization-out basket_optimization.json] [--budget-repair-out budget_repair.json] [--budget-deal-out budget_deal.json] [--repair-budget|--no-budget-repair] [--allow-budget-product-switches|--no-budget-product-switches] [--allow-budget-recipe-swap|--no-budget-recipe-swap] [--pantry-profile pantry_profile.json] [--pantry-out pantry.json] [--pantry-consumption-out pantry_consumption.json] [--readiness-out readiness.json] [--manifest-out manifest.json] [--audit-out audit.json] [--audit-mode off|warn|fail] [--record-live-snapshot dir|--replay-live-snapshot dir] [--snapshot-strict] [--snapshot-id id] [--pdf-out file.pdf] [--html-out file.html|--no-html] [--enrich-products] [--strict-quantity] [--recover-missing|--no-recovery] [--allow-recipe-swap|--no-recipe-swap] [--optimize-basket|--no-basket-optimization] [--basket-objective safe-balanced|lowest-price|lowest-waste] [--default-pantry none|minimal-spanish|mediterranean-basic] [--allow-assumed-pantry|--require-confirmed-pantry] [--require-safe-basket] [--require-cook-ready] [--json]")
