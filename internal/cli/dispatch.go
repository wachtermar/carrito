...
func printFoodHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  carrito food pdf <recipe-or-plan-or-shop.json> --out file.pdf")
	fmt.Fprintln(w, "  carrito food run --days N --people N [--selection-policy POLICY] [--basket-out basket.txt] [--json]")
