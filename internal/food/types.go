...
type FoodRunArtifact struct {
	...
	PreBudgetRepairReadinessGate      *ReadinessGate                `json:"pre_budget_repair_readiness_gate,omitempty"`
	BudgetRepairPlan                  *BudgetRepairPlan             `json:"budget_repair_plan,omitempty"`
	BudgetDealReport                  *BudgetDealReport             `json:"budget_deal_report,omitempty"`
